import { g as getHash, d as dataMediaQueries, b as slideDown, c as setHash, s as slideUp, a as slideToggle, e as bodyLockToggle, f as bodyLockStatus } from "./common.min.js";
(function polyfill() {
...
document.addEventListener("DOMContentLoaded", function() {
  ...
  function initFormValidation(form) {
    ...
    form.addEventListener("submit", function(event) {
      ...
      if (checkbox && !checkbox.checked) {
        isValid = false;
        showError(checkbox, "You must agree to receive communications");
      }
      if (isValid) {
        if (submitButton) {
  ...
  function showError(field, message) {
    const messagesContainer = field.closest("form").querySelector(".form-messages");
  ...
  function showSuccessMessage(form) {
    ...
    if (formTitle) {
      if (formTitle.textContent.toLowerCase().includes("comment")) {
        titleText = "Comment posted!";
      } else if (formTitle.textContent.toLowerCase().includes(" stay in touch") || formTitle.textContent.toLowerCase().includes("subscribe")) {
...
if (!document.getElementById("form-validation-styles")) {
  ...
  styleElement.textContent = `
    ...
    .custom-checkbox__input.invalid + .custom-checkbox__text {
